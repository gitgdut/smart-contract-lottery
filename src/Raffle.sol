...
contract Raffle is VRFConsumerBaseV2Plus {
    ...
    bool private s_caculatingWinner = false;
    ...
    function enterRaffle() public payable {
        ...
        if (msg.value < i_entranceFee) {
            //The style that cost the least gas fee
     ...
     * 4. The lottery has at least one player.
     * @param - (ignored)
    ...
    function pickWinner() external {
        //Check to see if enough  time has past
